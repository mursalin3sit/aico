...
import image9 from "~/assets/img/products/product9.jpg";
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      productsToShowCount: 9,
    };
  },
  methods: {
    loadMore() {
      if (this.productsToShowCount >= this.products.length) return;
      this.productsToShowCount = Math.min(
        this.productsToShowCount + 3,
  ...
  computed: {
    productsLoaded() {
      return this.products.slice(0, this.productsToShowCount);
    },
  },
});
</script>
