  ...
  <div class="privacy-policy-area ptb-100">
    <div class="container">
      <div
        ...
        data-aos-delay="200"
      >
        <p>Last updated on July 22, 2023.</p>
        <p>
          Hi there, we’re <strong>Aico</strong>, and welcome to our privacy
          policy which also applies to our customers.
          <br />
          This policy sets out how we handle your personal information if you’re
          an <strong>Aico</strong> user or visitor to our site.
        </p>
        <p>
          When we say ‘we’, ‘us’, or <strong>‘Aico’</strong>, it’s because
          that’s who we are and we own and run the site.
          <br />
          If we say ‘policy’ we’re talking about this privacy policy. If we say
          ‘user terms’ we’re talking about the rules for using the site. The
          rules vary by product; each product makes them separately available
        ...
        <p>
          ...
          you complete membership registration and buy items or services on our
          site, subscribe to a newsletter, email list, submit feedback or send
          us a communication.
        </p>
        <h4>How we use personal information</h4>
        <p>
          This data is intended to identify you as our
          <a href="#">customer/subscriber</a> and deliver products/information
          and other marketing elements. Visitors aren’t allowed to purchase any
          product or subscribe to the newsletter or make a comment anonymously.
          So, this information is the only means we can identify you and allow
          you to make these actions on the site.
        </p>
        <h4>When we disclose your personal information</h4>
        <p>
          We won’t disclose your data to third parties in a way as to reveal any
          of your personal information like email, name, etc. (subject to laws
          and regulations). Only our <i>authorities</i> have access to your data
        ...
        <p>
          ...
          <a href="#" target="_blank">information</a> that we store is protected
        ...
        <p>
          You can access some of the personal information we collect by logging
          in to your account. You also have the right to request access to other
          personal information we hold about you and to request corrections of
          any errors in that data. Contact our support using the contact details
        ...
        <p>
          ...
          be of interest to you. You can ‘opt-out’ of such communications if you
        ...
        <p>
          ...
          or to provide you with the <strong>Aico</strong> services, you can
        ...
        <p>
          ...
          stays up to date with the latest legal requirements and any changes to
          our privacy management practices. When changing the policy, we will
          notify you about such changes; where required, a copy of the latest
        ...
        <p>
          ...
          support at <a href="hello@aico.com">hello@aico.com</a>.
        </p>
        <p>
